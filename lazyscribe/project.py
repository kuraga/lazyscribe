...
class Project:
    ...
    **storage_options
    ...
    def to_tabular(self) -> tuple[list[dict], list[dict]]:
        ...
        -------
        list[dict]
            The ``experiments`` list. Each entry is a result of :py:meth:`lazyscribe.Experiment.to_tabular`
            per project's experiment.
        list[dict]
            The ``tests`` list. Each entry is a result of :py:meth:`lazyscribe.Test.to_tabular`
